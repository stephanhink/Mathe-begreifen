# Play-Store-Eintrag: Mathe begreifen

Zum Kopieren in die Play Console (App-Inhalte → Store-Eintrag).
...
Mathe begreifen macht die Schulmathematik nachvollziehbar — nicht durch
...
keine Werbung, keine In-App-Käufe, kein Tracking, keine Internetverbindung
nötig. Dein Lernstand bleibt auf dem Gerät und wird nirgendwohin gesendet;
du kannst ihn jederzeit selbst löschen.
...
## Zielgruppe (App-Inhalte → Zielgruppe und Inhalte)

**Hier weicht Mathe von Chemie ab — bitte nicht aus dem Chemie-Eintrag
übernehmen.**

Chemie begreifen richtet sich an die Oberstufe, dort ist „16–17" und
„18 und älter" korrekt. Mathe begreifen beginnt bei **Klasse 5**, also bei
Zehnjährigen. Die Altersgruppen unter 13 wegzulassen wäre eine Falschangabe
gegenüber Google — und die Store-Beschreibung, die „ab Klasse 5" sagt,
widerspräche ihr offen.

Anzugeben sind daher **alle** Gruppen ab „9–12" aufwärts:
9–12, 13–15, 16–17, 18 und älter.

Damit gilt die App als *Mixed Audience* und fällt unter Googles
Families-Richtlinie. Das ist hier ohne Zusatzaufwand erfüllbar, weil die App
ohnehin nichts von dem tut, was die Richtlinie verbietet:

| Auflage der Families-Richtlinie | Stand dieser App |
|---|---|
| Keine Werbung von nicht zertifizierten Anbietern | keine Werbung |
| Keine In-App-Käufe ohne Elternfreigabe | keine In-App-Käufe |
| Keine Erhebung personenbezogener Daten von Kindern | keine Erhebung |
| Kein Anmeldezwang für Kinder | keine Anmeldung |
| Keine sozialen Funktionen ohne Moderation | keine Kommunikation |
| Datenschutzerklärung verlinkt | siehe unten |

Zu erwarten ist lediglich eine etwas gründlichere Prüfung durch Google und
der zusätzliche Fragebogen zur Families-Selbstzertifizierung.

## Datensicherheit (App-Inhalte → Datensicherheit)

- Werden Nutzerdaten erhoben oder geteilt? **Nein**
- Werden Daten verschlüsselt übertragen? entfällt (keine Übertragung)
- Können Nutzer die Löschung beantragen? entfällt (keine Übertragung)

**Warum trotz gespeichertem Lernstand „nein" richtig ist:** Googles Frage
zielt auf Daten, die das Gerät verlassen. Der Lernstand tut das nicht — er
liegt im lokalen App-Speicher und wird an keinen Server gesendet. Er enthält
außerdem kein personenbezogenes Merkmal: kein Name, keine Kennung, keine
Uhrzeit, nur Themen-IDs, Zählerstände und Fälligkeitsdaten. Beim
Deinstallieren verschwindet er, und im Lückenfinder gibt es den Knopf
„Lernstand löschen“.

Trotzdem steht er ausdrücklich in der Datenschutzerklärung. Was gespeichert
wird, gehört dort hinein — auch wenn es das Gerät nie verlässt.
...
https://stephanhink.github.io/Mathe-begreifen/datenschutz.html

> Diese URL funktioniert erst, wenn GitHub Pages aktiviert ist:
> Repo-Settings → Pages → Branch `main`, Ordner `/docs`.
> Vorher lehnt die Play Console die Einreichung ab.

## Grafiken — was noch fehlt
...
Mathe begreifen makes school mathematics make sense — not by memorizing
...
No result without a route. 3x + 5 = 14 does not become "x = 3" but: subtract
5 from both sides, then divide both sides by 3. You can read that aloud,
copy it, and repeat it in an exam. Arithmetic is exact and done in
fractions: a third plus a third plus a third is 1, not 0.9999999998.

YOUR OWN WORKING
You can type in your own derivation line by line. The app then tells you not
merely "wrong", but from WHICH LINE onwards it stops being true — and why.
...
purchases, no tracking, no internet connection required. Your progress stays
on your device and is never transmitted; you can delete it yourself at any
time.

DISCLAIMER
An aid for learning mathematics. It replaces neither lessons nor a teacher's
explanation.
